...
class Net(torch.nn.Module):
    ...
    def __init__(self,inputsize,taskcla):
        ...
        self.sizefc1 = int(expand_factor*256)

        self.fc2=torch.nn.ModuleList()
        self.sizefc2 = int(expand_factor*256)
    ...
    def forward(self,x,t,P=None):
        ...
        h_pre=self.drop1(self.relu(self.fc1[P[0,0]](h)))
        for j in range(1,self.N):
            h_pre = h_pre + self.drop1(self.relu(self.fc1[P[0,j]](h))) #sum activations
        h = h_pre
